...
globalkeys = gears.table.join(
    ...
    -- Rofi
    awful.key({ modkey },            "d",     function ()-- awful.screen.focused().mypromptbox:run() 
    awful.util.spawn("rofi -show drun")end,
              {description = "Rofi", group = "My_Stuff"}),

-- Browser
	awful.key({modkey}, "b", function ()
		
	awful.util.spawn("firefox")end, 
			{description = "Browser", group = "My_Stuff"}),
	
	awful.key({modkey}, "c", function ()

	awful.util.spawn("thunderbird")end,
			{description = "Emails", group = "My_Stuff"}),
...
for i = 1, 9 do
  ...
  -- Brightness
    ...
    -- awful.key({ }, "XF86AudioPause", function ()
     --     awful.util.spawn("playerctl pause") end),     
...
-- Audio Control
	  awful.key({}, "XF86AudioRaiseVolume", function ()
		  awful.util.spawn("pactl set-sink-volume @DEFAULT_SINK@ +1%") end),
...
-- Autostart
awful.spawn.with_shell("feh --bg-scale ~/Pictures/arch.png")
